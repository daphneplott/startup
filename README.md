...
- [x] **Images** - The Home page has a magical castle image, the potions pages have a cauldren with green smoke, and the astronomy pages have a starry sky. The images will eventually become background images, not just on the page.
